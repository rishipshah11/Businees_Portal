									...
									<tbody>
										...
										while($row=$category->fetch_object())
										{
											...
											<td class="table-action">
												<a href="editcat.php?edid=<?php echo $row->cat_id; ?>"><i class="align-middle" data-feather="edit-2"></i></a>
												<a href="delcat.php?delid=<?php echo$row->cat_id; ?>"><i class="align-middle" data-feather="trash"></i></a>
											</td>
										</tr>
										<?php
