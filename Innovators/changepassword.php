...
if(isset($_POST['submit']))
{
	...
	$result=$obj->query("select * from innovator where inno_id='$id'");
	...
	if($oldpass==$old)
	{
		if($new==$cnew)
		{
			$exe=$obj->query("update innovator set password='$new' where inno_id='$id'");
			if($exe)
			{
...
<div class="card-body">
	...
	<div class="mb-4 row">
		<div class="col-sm-9 ml-sm-auto">
			<input type="submit" name="submit" value="Update Password" class="btn-primary p-2">
		</div>
	</div>
	</form>
	</div>
